...
import static org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.db2.DB2DataTypeConvertor.DB2_XML;


@Slf4j
public class DB2Catalog extends AbstractJdbcCatalog {

    private static final DB2DataTypeConvertor DATA_TYPE_CONVERTOR =
            new DB2DataTypeConvertor();

    protected static List<String> EXCLUDED_SCHEMAS =
            Collections.unmodifiableList(
                    Arrays.asList("SYSTOOLS",
                            "SYSSTAT",
                            "SYSIBMTS",
                            "SYSPUBLIC",
                            "SYSPROC",
