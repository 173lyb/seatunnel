...
public enum SyBaseType implements SQLType {
    ...
    GUID("uniqueidentifier", java.sql.Types.VARCHAR, String.class),
    SQL_VARIANT("sql_variant", java.sql.Types.VARCHAR, Object.class),
    UDT("udt", java.sql.Types.VARBINARY, byte[].class),
    XML("xml", -16, String.class),
    TIMESTAMP("timestamp", java.sql.Types.BINARY, byte[].class),
    GEOMETRY("geometry", java.sql.Types.LONGVARCHAR, Object.class),
    GEOGRAPHY("geography", java.sql.Types.LONGVARCHAR, Object.class),
    SYSNAME("sysname", Types.VARCHAR, String.class);
