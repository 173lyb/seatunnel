...
public class KingBaseCreateTableSqlBuilder {
    ...
    private KingBaseDataTypeConvertor kingBaseDataTypeConvertor;
    ...
    public KingBaseCreateTableSqlBuilder(CatalogTable catalogTable) {
        ...
        this.kingBaseDataTypeConvertor = new KingBaseDataTypeConvertor();
    ...
    private String buildColumnType(Column column) {
        ...
        switch (sqlType) {
            ...
            default:
                String type =
                        kingBaseDataTypeConvertor.toConnectorType(
