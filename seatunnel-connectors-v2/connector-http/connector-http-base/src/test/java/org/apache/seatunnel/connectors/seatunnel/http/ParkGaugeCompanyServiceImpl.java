...
public class ParkGaugeCompanyServiceImpl {
    ...
    private static final String APP_URL = "https://open.lqysz.com/service-open/parkBusiness/getParkGaugeCompany";
    ...
    public static void main(String[] args) {
        ...
        String signature = Md5Util.md5Lower("appKey=" + APP_KEY + "&appSecret=" + APP_SECRET + "&timestamp=" + ts);
