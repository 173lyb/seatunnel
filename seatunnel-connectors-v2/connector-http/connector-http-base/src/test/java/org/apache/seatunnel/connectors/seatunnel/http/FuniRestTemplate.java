...
/**
 * @ClassName FuniRestTemplate @Description 接口请求示例 @Author YangFeng @Date 2022/9/15 22:47 @Version
 * 1.0
 */
@Slf4j
public class FuniRestTemplate {
    public static void main(String[] args) {
        ...
        //        requestParams.put("authenticationKey",new Base64Encoder().encode((loginid + ":" +
        // password + ":" + nowTimestamp).getBytes()));
        ...
        // RestTemplate(FuniRestTemplate.generateHttpRequestFactory());
        //        JSONObject jsonObject = restTemplate.postForObject(URL, requestParams,
        // JSONObject.class);
     ...
     * @author YangFeng
     */
    //    public static HttpComponentsClientHttpRequestFactory generateHttpRequestFactory() throws
    // NoSuchAlgorithmException, KeyManagementException, KeyStoreException {
    //        TrustStrategy acceptingTrustStrategy = (x509Certificates, authType) -> true;
    //        SSLContext sslContext = SSLContexts.custom().loadTrustMaterial(null,
    // acceptingTrustStrategy).build();
    //        SSLConnectionSocketFactory connectionSocketFactory = new
