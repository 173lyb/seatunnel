...
public class HttpConfig {
    ...
    public static final Option<Boolean> PARAMS_ADD =
            Options.key("params_add")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "是否追加请求参数params到所读取json的指定路径下，需要与params_path配合使用，默认追加到根路径");
    public static final Option<String> PARAMS_PATH =
            Options.key("params_path")
                    .stringType()
                    .defaultValue("$")
                    .withDescription(
                            "指定请求参数params追加到所读取的json的路径");
    ...
    public static final Option<Boolean> HEADERS_ADD =
            Options.key("headers_add")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "是否追加请求header到所读取json的指定路径下，需要与headers_path配合使用，默认追加到根路径");
    //headerPath
