...
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.ACCOUNT_KEY;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.REQUEST_TIME;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.SECRET_KEY;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.SIGNATURE;
...
public class HeaderSHA256Strategy implements EncryptStrategy {
    ...
    public Map<String, String> encryptHeader(
        ...
        LocalDateTime localDateTime =
                TimeUtils.parseDateTime(requestTime, TimeUtils.Formatter.YYYY_MM_DD_HH_MM_SS_SSS);
