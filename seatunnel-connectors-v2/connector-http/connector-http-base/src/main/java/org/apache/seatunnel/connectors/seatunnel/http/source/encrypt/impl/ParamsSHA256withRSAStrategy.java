...
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.BIZ_CONTENT;
...
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.REQUEST_ID;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.SIGN;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.TIMESTAMP;
...
public class ParamsSHA256withRSAStrategy implements EncryptStrategy {
    ...
    public Map<String, String> encryptParam(
        ...
        if (StringUtils.isBlank(privateKey)
                || StringUtils.isBlank(biz_content)
                || StringUtils.isBlank(access_key)
                || StringUtils.isBlank(decrypt_biz_content)) {
            throw new SeaTunnelException(
                    "privateKey, biz_content ,access_key, encrypt_biz_content 不能为空");
        }
