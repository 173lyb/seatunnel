...
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.SECRET_KEY;
...
public class BodySignMd5Strategy implements EncryptStrategy {
    ...
    private String getRequiredStringValue(Map<String, ?> map, String key)
            throws SeaTunnelException {
