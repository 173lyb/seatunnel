...
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.CID;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.SIGN;
import static org.apache.seatunnel.connectors.seatunnel.http.constants.encryptConstant.TS;
...
public class EncryptRequest {
     ...
     */
    public static Map<String, String> SignEncryptRequestParam(Map<String, String> params)
            throws Exception {
        if (null == params) {
            return params;
        }
    ...
    public static Map<String, String> encryptRequestParam2(
            Map<String, String> params, Map<String, String> paramsEncrypt) throws Exception {
     ...
     * @throws Exception
     */
    public static Map<String, String> encryptRequestHeader(
        ...
        if ("SHA256".equals(encryptType)) {
            ...
            LocalDateTime localDateTime =
                    TimeUtils.parseDateTime(
                            requestTime, TimeUtils.Formatter.YYYY_MM_DD_HH_MM_SS_SSS);
            ...
            String signature =
                    org.apache.commons.codec.digest.DigestUtils.sha256Hex(signatureBefore);
     ...
     * @return
     */
    public static String encryptRequestBody(
            String body, Map<String, String> bodyEncrypt, Map<String, String> params) {
        ...
        if ("SIGN-MD5".equals(encryptType)) {
            ...
            if (StringUtils.isNotBlank(secretKey)) {
                ...
                LocalDateTime localDateTime =
                        TimeUtils.parseDateTime(ts, TimeUtils.Formatter.YYYY_MM_DD_HH_MM_SS_SSS);
                LocalDateTime localDateTimeCid =
                        TimeUtils.parseDateTime(cid, TimeUtils.Formatter.YYYY_MM_DD_HH_MM_SS_SSS);
            ...
            String signature =
                    Md5Util.md5Lower(
                            "appKey=" + appKey + "&appSecret=" + appSecret + "&timestamp=" + ts);
    ...
    /** 拦截海康sdk */
    public static HttpResponse handleHikvisionApi(
            String uri,
            String body,
            ...
            Map<String, String> hikvisionApi) {
        // 提取出host和path
        URL url = null;
        ...
        String result =
                ArtemisHttpUtil.doPostStringArtemis(path, body, querys, null, contentType, header);
