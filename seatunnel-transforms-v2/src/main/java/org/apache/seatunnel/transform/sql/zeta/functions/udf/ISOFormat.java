...
public class ISOFormat implements ZetaUDF {
    ...
    public Object evaluate(List<Object> args) {
        ...
        DateTimeFormatter formatter =
                Strings.isNullOrEmpty(NewFormat)
    ...
    public Object evaluate2(List<Object> args) {
        ...
        DateTimeFormatter dtfInput =
                new DateTimeFormatterBuilder()
                        .appendPattern(
                                "[yyyy-MM-dd'T'HH:mm:ss.SSSX][yyyy-MM-dd'T'HH:mm:ssX][yyyy-MM-dd'T'HH:mm:ssXXX]")
                        .toFormatter();
        DateTimeFormatter formatter =
                Strings.isNullOrEmpty(NewFormat)
                        ? DateTimeFormatter.ofPattern(DEFAULT_FORMAT)
        ...
        try {
            TemporalAccessor ta =
                    dtfInput.parseBest(
                            dateStr, ZonedDateTime::from, LocalDateTime::from, LocalDate::from);
