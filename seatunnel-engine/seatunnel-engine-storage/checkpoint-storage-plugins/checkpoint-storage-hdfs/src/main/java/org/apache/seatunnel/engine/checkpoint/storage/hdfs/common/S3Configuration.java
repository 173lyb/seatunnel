...
public class S3Configuration extends AbstractConfiguration {
    ...
    public Configuration buildConfiguration(Map<String, String> config) {
        ...
        hadoopConf.setBoolean(String.format(COMMON_DISABLE_CACHE, formatKey(protocol, HDFS_IMPL_KEY))
                , Boolean.parseBoolean(config.getOrDefault(DISABLE_CACHE_KEY, DISABLE_CACHE_DEFAULT_VALUE)));
